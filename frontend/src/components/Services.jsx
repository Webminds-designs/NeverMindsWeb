...
const serviceItems = [
  ...
  // Box 1
  {
    title: (
      <div className="flex font-sinhala flex-col items-left text-left text-black p-6 h-full">
        ...
        {/* Title */}
        <h3 className={`text-[40px] sm:text-[50px] md:text-[45px] text-left font-semibold leading-tight mb-4 ${language === 'si' ? 'md:text-[30px] text-[35px]' : ''}`}>
  ...
  {content[language].service1_title3}
        ...
        {content[language].service1_description} <br></br> {content[language].service1_description2} <br></br>  {content[language].service1_description3} 
          <br></br> {content[language].service1_description4} 
        </p>
  ...
  // Box 2
  {
    title: (
      <div className="relative flex flex-col text-left items-left text-black p-6 h-full">
        ...
        {content[language].service2_title} <br />   {content[language].service2_title2}
        </h3>

        {/* Subtitle */}
        <p className="text-[18px] sm:text-[20px] font-normal leading-tight mt-2">
        {content[language].service2_description} <br></br>   {content[language].service2_description2}
        </p>
      </div>
    ),
    header: null,
  ...
  // Box 3
  {
    title: (
      <div className="relative flex flex-col text-center items-center text-black p-6 h-full">
        ...
        {/* Subtitle */}
        <p className="text-[18px] sm:text-[20px] font-normal leading-tight mt-2">
        {content[language].service3_description}<br></br>  {content[language].service3_description2}<br></br>  {content[language].service3_description3}{" "}
        </p>
      </div>
    ),
    header: null,
  ...
  // Box 4
  {
    title: (
      <div className="relative flex flex-col items-end text-black p-6 h-full">
        ...
        {content[language].service4_description} <br />  {content[language].service4_description2}
        </p>
      </div>
    ),
    header: null,
    ...
    title: (
      <div className="relative flex flex-col text-right text-black h-full p-6">
        ...
        <div className="mb-16">
          ...
          {content[language].service5_title} <br />   {content[language].service5_title2} <br />   {content[language].service5_title3}
          </h3>
          {/* Subtitle */}
          <p className="text-[18px] sm:text-[20px] font-normal leading-tight mt-4">
          {content[language].service5_description}<br></br>   {content[language].service5_description2}<br></br>   {content[language].service5_description3}
          </p>
        </div>
  ...
  // Box 6
  {
    title: (
      <div className="flex flex-col items-center text-left text-black p-6 h-full">
        ...
        {content[language].service6_title} <br />  {content[language].service6_title2} <br />  {content[language].service6_title3}
        </h3>

        {/* Description */}
        <p className="text-[18px] sm:text-[24px] text-center leading-tight font-normal mb-4">
        {content[language].service6_description}<br></br>  {content[language].service6_description2}<br></br> 
        {content[language].service6_description3}<br></br>  {content[language].service6_description4}</p>
      </div>
    ),
    header: null,
  },
  ...
  // Box 7
  {
    title: (
      <div className="relative flex flex-col text-left items-left text-black p-6 h-full">
        {/* Title */}
        <h3 className="text-[30px] sm:text-[28px] font-semibold leading-tight">
        {content[language].service7_title} <br />    {content[language].service7_title2}
        </h3>

        {/* Subtitle */}
        <p className="text-[18px] sm:text-[20px] font-normal leading-tight mt-4">
        {content[language].service7_description}<br></br>  {content[language].service7_description2}{" "}
        </p>
        {/* Image Positioned Top-Right */}
        <img
          src={graph}
  ...
  // Box 8
  {
    title: (
      <div className="relative flex flex-col text-end items-end text-black p-6 h-full">
        ...
        {/* Subtitle */}
        <p className="text-[18px] sm:text-[20px] font-normal leading-tight mt-4">
        {content[language].service8_description}<br></br>  {content[language].service8_description2}{" "}
        </p>
      </div>
    ),
    header: null,
  ...
  // Box 9
  {
    title: (
      <div className="relative flex flex-col items-start text-black p-6 h-full">
        ...
        {content[language].service9_Quizz} </span>
      ...
      "
        ...
        {content[language].service9_title}<br></br> {content[language].service9_title2}
        </h3>

        {/* Subtitle */}
        <p className="text-[16px] sm:text-[30px] text-left font-normal mt-2">
        {content[language].service9_description}<br></br> {content[language].service9_description2}
        </p>
      </div>
    ),
    header: null,
  ...
  // Box 10
  {
    title: (
      <div className="relative flex flex-col text-center items-center text-black p-6 h-full">
        ...
        {/* Title */}
        <h3 className="text-[30px] sm:text-[28px] font-semibold">
        {content[language].service10_title}<br></br> {content[language].service10_title2}
        </h3>

        {/* Subtitle */}
        <p className="text-[18px] sm:text-[20px] font-normal leading-tight">
        {content[language].service10_description}<br></br>  {content[language].service10_description2}
        </p>
      </div>
    ),
    header: null,
