    ...
    >
      ...
      <div className="inset-0 bg-gradient-to-r via-white/80 to-transparent flex flex-col lg:flex-row p-8 md:p-16">
        ...
        <div className="w-full text-black flex flex-col lg:items-start items-center lg:gap-y-7 lg:mt-32 lg:mb-0 mb-[600px]">
          <h1 className="lg:text-[50px] text-4xl font-semibold leading-tight mb-4 flex flex-col text-center lg:text-left">
            <p>Challenge Your</p>
            <p>Knowledge Beyond</p>
            <p>Limits</p>
          </h1>
          <span className="text-[18px] md:text-[20px] lg:text-[24px] text-center lg:text-left mb-6">
        ...
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <div className="absolute bottom-2 lg:bottom-5 lg:right-10 bg-white border-2 border-[#fbc72e] rounded-lg p-4 w-64 lg:w-72">
            <div className="mb-2">
              ...
              <div>
                <span className="font-light text-xl lg:text-2xl">Powered by</span>
                <span className="font-medium text-2xl lg:text-4xl mx-2">15</span>
